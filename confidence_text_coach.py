...
if st.button("🔍 Analyze Message"):
    if not user_email:
        error_placeholder.error("Please enter your email to continue.")
    elif not ACCESS_GRANTED and (looks_like_thread or multiline):
        error_placeholder.error("🛑 This looks like more than a single message. Full conversation analysis and context/backstory are premium features. [Upgrade here](https://coachnofluff.gumroad.com/l/textcoach)")
    elif can_analyze:
